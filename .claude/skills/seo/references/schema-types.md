...
| SitelinksSearchBox | Retired from rich results | January 2026 | Sitelinks search box discontinued; remove SearchAction from WebSite schema |
| Q&A (QAPage) | Retired from rich results | January 2026 | Q&A rich results no longer displayed in search |
