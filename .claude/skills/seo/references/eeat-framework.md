...
The most critical pillar — **an untrustworthy page receives a low overall E-E-A-T score regardless of how high its Experience, Expertise, or Authoritativeness signals are.** Trust is the foundational assessment that gates the value of all other signals.
...
### AI Content Quality Tiers (December 2025 Update)

Google's quality raters now use a formal tiered assessment for AI-generated content:

| Tier | Description | Ranking Impact |
|------|-------------|----------------|
| **Human-directed AI** | AI assists; human edits, adds expertise, verifies facts | Neutral to positive |
| **AI with oversight** | AI drafts; human reviews for accuracy and adds context | Neutral |
| **Scaled AI, no oversight** | Mass AI content with minimal or no editorial review | Strongly negative |
| **Lowest quality** | AI spam — no value, no editing, purely for traffic | Penalty / de-indexing |

**Key insight:** The determining factor is NOT whether AI was used, but whether humans added genuine value. "Human-directed AI" content can rank as well as fully human content when it demonstrates real E-E-A-T signals.
